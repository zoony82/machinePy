...
class KaggleWord2VecUtility(object):
    """
    this is a utility class for processing raw html text
    into segments for further learning
    """
    @staticmethod
    def review_to_wordlist(review, remove_stopwords=False):
        # Function to convert a document to a sequence fo words.
        ...
        # 4. Optionally remove stop words (flase by default)
        if remove_stopwords:
    ...
    def review_to_sentences(review, tokenizer, remove_stopwords=False):
        ...
        # so this return a list of lists
        return sentences
